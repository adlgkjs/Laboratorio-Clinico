...
class CitaController extends Controller
{
    ...
    public function agendarNuevaCita(Request $request)
    {
        ...
        try {
            ...
            $paciente->num_int = isset($infoCita['no_int']) ? $infoCita['no_int'] : null;
            $paciente->colonia = $infoCita['colonia'];
            $paciente->cp = isset($infoCita['cp']) ? $infoCita['cp'] : null;
            ...
            $cita->comentarios = $infoCita['comentarios'];
            $cita->save();
    ...
    public function actualizarCita(Request $request)
    {
        ...
        try {
            ...
            if ($paciente) {
                ...
                $paciente->correo = $infoCita['paciente']['correo'];
                $paciente->telefono = $infoCita['paciente']['telefono'];
                $paciente->calle = $infoCita['paciente']['calle'];
                $paciente->num_ext = $infoCita['paciente']['num_ext'];
                $paciente->num_int = isset($infoCita['paciente']['num_int']) ? $infoCita['paciente']['num_int'] : null;
                $paciente->colonia = $infoCita['paciente']['colonia'];
                $paciente->cp = isset($infoCita['paciente']['cp']) ? $infoCita['paciente']['cp'] : null;
                $paciente->municipio = $infoCita['paciente']['municipio'];
                $paciente->estado = $infoCita['paciente']['estado'];
                $paciente->pais = $infoCita['paciente']['pais'];
                $paciente->save();
            } else {
    ...
    public function generarPDF(Request $request)
    {
        ...
        try {
            ...
            $html = view('pdf.detalleCitaAdmin', compact('folio', 'fecha', 'hora', 'infoCita', 'estudios', 'total'))->render(); //Se carga la vista y se pasan los datos   
