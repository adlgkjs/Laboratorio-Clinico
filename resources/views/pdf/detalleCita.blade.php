...
<body>
    ...
    @isset($infoCita['fecha_nacimiento'])
    ...
    @isset($infoCita['correo'])
    <p>Correo: <strong>{{$infoCita['correo']}}</strong>.</p>
    @endisset

    @isset($infoCita['calle'])
    <p>Domicilio:
        <strong>
            {{$infoCita['calle']}}
            {{$infoCita['no_ext'] ?? $infoCita['num_ext']}},
            int. {{$infoCita['no_int'] ?? $infoCita['num_int'] ?? 'S/N'}}.
            col. {{$infoCita['colonia']}},
            cp. {{$infoCita['cp']}},
            {{$infoCita['municipio']}},
            {{$infoCita['estado']}},
            {{$infoCita['pais']}}.
    ...
    <p>Fecha: <strong>{{$infoCita['fecha'] ?? $fecha}}.</strong></p>
    <p>Hora:
        <strong>
            @isset($infoCita['hora'])
            {{$infoCita['hora']}}:{{$infoCita['minutos']}} hrs.
            @else
            {{$hora}}
            @endisset
        </strong>
